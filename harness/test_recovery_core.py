...
def test_recovery_on_emits_exactly_the_recovery_cards(tmp_path):
    ...
    # OTHER rails untouched by recovery -> the DEFAULT regulation = the stiff R_a resistor
    # (conductance 1/Ra at every excursion); no recovery tokens, no Icomp compliance.
