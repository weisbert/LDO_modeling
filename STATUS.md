...
|---|---|---|---|
| large-signal-recovery | PART2 compressive assist (`78f5a7a`) + **Route 1 unload-discharge SHIPPED** (fit-inductor drain: +302 mV(>supply)→+34 mV(≤supply), AC/dip bit-identical, +40 mA pinned, survives minimal; ovVdz=25 mV transparency floor) | `bash apply` + box re-validate (now carries assist + discharge) | `docs/threads/large-signal-recovery.md` |
